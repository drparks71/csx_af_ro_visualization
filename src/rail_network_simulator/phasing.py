...
def phase_2_stage_1():
    ...
    red_nodes = [11, 20, 25, 40, 41, 44, 45, 46, 47, 49, 50, 51, 75, 76, 77, 78,
                 80, 81, 83, 87, 89, 90, 91, 92, 93, 94, 95, 98, 99, 100, 103, 104, 105, 106]
    ...
    red_links = [1, 2, 15, 17, 51, 52, 53, 54, 76, 77, 78, 82, 83, 86, 87, 88,
                 89, 90, 91, 92, 94, 95, 96, 97, 98, 102, 105, 106, 107, 113, 114, 116, 117]
...
def phase_2_stage_3():
    ...
    red_nodes = [21, 86, 100, 78, 25, 80, 20, 43, 84, 54, 82, 60, 62, 64, 85, 66, 71, 61]
